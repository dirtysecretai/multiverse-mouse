        ...
        <div className="space-y-8 text-slate-300">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="p-3 bg-yellow-500/10 border border-yellow-500/30 rounded text-sm">
                      <p className="text-yellow-400 font-bold mb-1">⚠️ Data Usage Policy:</p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="p-3 bg-green-500/10 border border-green-500/30 rounded text-sm">
                        <p className="text-green-400 font-bold mb-1">✓ Paid Services:</p>
          ...
          <section>
            ...
            <div className="bg-yellow-500/10 border-2 border-yellow-500/30 p-5 rounded-lg mb-4">
              <p className="font-bold text-yellow-400 mb-3 text-lg">⏱️ Automatic Data Deletion Timeline</p>
          ...
          <section>
            ...
            <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-lg">
              ...
              <div className="mt-4 p-3 bg-green-500/10 border border-green-500/30 rounded">
                <p className="text-sm font-bold text-green-400">✓ We do NOT sell your personal information</p>
