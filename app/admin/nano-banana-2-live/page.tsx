...
const FEED_KEY = 'nb2-live-session-feed'
const ACTIVE_KEY = 'nb2-live-active-count'
const PROMPT_KEY = 'nb2-live-prompt'
...
export default function NanaBanana2LivePage() {
    ...
    return (
      <div className="min-h-screen bg-[#050810] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-black text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500 mb-6">
            NANO BANANA PRO 2 — LIVE
          </h1>
          <form onSubmit={handleLogin} className="p-6 rounded-xl border border-slate-800 bg-slate-900/60">
            <input
              ...
              className="w-full p-3 rounded-lg bg-slate-950 border border-slate-700 text-white focus:border-green-500 focus:outline-none mb-4"
            />
            <button type="submit" className="w-full py-3 rounded-lg bg-gradient-to-r from-green-500 to-emerald-500 text-black font-black">
              ACCESS
            </button>
          </form>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#050810] text-white">
      <div className="fixed inset-0 bg-[linear-gradient(rgba(34,197,94,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(34,197,94,0.02)_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none" />

      {/* Header */}
      <div className="sticky top-0 z-20 border-b border-green-500/20 bg-slate-900/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">
                NANO BANANA PRO 2 — LIVE
              </h1>
              <p className="text-[10px] text-slate-500 font-mono">fal-ai/nano-banana-2 · Live</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex gap-6 items-start">
        ...
        <div className="w-80 flex-shrink-0 space-y-4">
          ...
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/60">
            ...
            <textarea
              ...
              rows={5}
              className="w-full p-3 rounded-lg bg-slate-950 border border-slate-700 focus:border-green-500 text-white text-sm placeholder:text-slate-600 focus:outline-none resize-none"
            />
          </div>
          ...
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/60">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-lg bg-slate-950 border border-slate-700 focus:border-green-500 text-white text-sm placeholder:text-slate-600 focus:outline-none"
              />
          ...
          <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/60 space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-all flex-shrink-0 ${limitGenerations ? 'bg-green-500' : 'bg-slate-700'}`}
              >
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-black text-sm tracking-widest transition-all ${
              !canGenerate
                ...
                : 'bg-gradient-to-r from-green-500 to-emerald-500 text-black hover:from-green-400 hover:to-emerald-400 shadow-lg shadow-green-500/20'
            }`}
          >
          ...
          <div className="p-3 rounded-xl border border-slate-800 bg-slate-950/60 font-mono text-[10px] text-slate-500 space-y-1">
            ...
            <p>aspect_ratio: <span className="text-green-400">{aspectRatio}</span></p>
            <p>resolution: <span className="text-emerald-400">{resolution}</span></p>
            <p>num_images: <span className="text-green-400">{numImages}</span></p>
            ...
            <p>limit_generations: <span className="text-green-400">{String(limitGenerations)}</span></p>
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          ...
          {loadingEntries.map(entry => (
            <div key={entry.id} className="flex items-center gap-4 p-4 rounded-xl border border-green-500/20 bg-slate-900/40">
              <Zap size={22} className="text-green-400 animate-pulse flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-green-400 font-bold text-sm">Generating...</p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-1.5">
                          ...
                          <a
                            ...
                            className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-green-500/20 hover:bg-green-500/30 text-green-400 text-[10px] transition-all"
                          >
          ...
          {sessionFeed.length === 0 && loadingEntries.length === 0 && !error && blockedSlots === 0 && (
            <div className="flex flex-col items-center justify-center h-96 rounded-xl border border-slate-800 bg-slate-900/20">
              ...
              <p className="text-slate-600 text-xs mt-1">fal-ai/nano-banana-2 · Live · Feed persists across refreshes</p>
            </div>
          )}
        </div>
      </div>
